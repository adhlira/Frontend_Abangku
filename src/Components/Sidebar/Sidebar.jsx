    ...
    <>
      <div className="category">
        <div className="box-category">
          <h3>Category</h3>
          <ul>
            <li onClick={() => { Scrollbar(); setPageBanner(1); }}>
              <Link to="bestseller" className="nav-link">
                <button>Best Seller</button>
              </Link>
            </li>
            <li onClick={() => { Scrollbar(); setPageBanner(2); }}>
          ...
          <ul>
            <li onClick={() => { Scrollbar(); setPageBanner(4); }}>
              <Link to="allproduct" className="nav-link">
                <button>All Product</button>
              </Link>
            </li>
            <li onClick={() => { Scrollbar(); setPageBanner(7); }}>
              <Link to="men" className="nav-link">
                <button>Men</button>
              </Link>
            </li>
            <li onClick={() => { Scrollbar(); setPageBanner(8); }}>
              <Link to="women" className="nav-link">
                <button>Women</button>
              </Link>
            </li>
            <li onClick={() => { Scrollbar(); setPageBanner(6); }}>
              <Link to="kid" className="nav-link">
                <button>Kid</button>
              </Link>
            </li>
            <li onClick={() => { Scrollbar(); setPageBanner(5); }}>
